function labelthumbs(t)
	...
	e++)
		...
		if(document.write('<span class="mastamvan_meta">'),1==showpostdate&&(R=R+'<span class="mastamvan_meta_date">'+C+"/"+$+"/"+x+"</span>"),1==showcommentnum&&("1 Comments"==l&&(l="1 Comment"),"0 Comments"==l&&(l="No Comments"),showcomment='<span class="mastamvan_meta_comment"><a title="'+i+'"  href="'+o+'">'+l+"</a></span>",R+=showcomment),1==displaymore&&(R=R+'<span class="mastamvan_meta_more"><a title="'+i+'" href="'+m+'" class="url">Read More</a></span><'+oh+yes+' style="width:0px;
		height:0px;
