function hubalabelthumbs(t) {
	...
	for (var e = 1; e < hubanumposts2; e++) {
		...
		var p = r.published.$t,
			...
			_ = p.substring(5, 7),
			f = p.substring(8, 10);
		1 == hubashowpostthumbnails2 && document.write('<a title="' + m + '" href="' + n + '"><div class="cat_thumb2"><img width="' + hubathumb_width2 + '" height="' + hubathumb_height2 + '" alt="' + m + '" src="' + x + '"/></div></a>'), document.write("<li>"), document.write('<span class="huba-label-title huba-label-title2"><a  title="' + m + '" href="' + n + '" target ="_top">' + m + "</a></span>");
		var v = "";
		document.write('<span class="huba-label-meta huba-label-meta2">'), 1 == hubashowpostdate2 && (v = v + '<span class="huba-label-meta-date">' + g[parseInt(_)] + " " + f + ", " + w + "</span>"), 1 == hubashowcommentnum2 && ("1 Comment" == l && (l = "1 Comments"), "0 Comment" == l && (l = "0 Comments"), showcomment = '<span class="huba-label-meta-comment huba-label-meta-comment2"><a href="' + o + '">' + l + "</a></span>", v += showcomment), 1 == hubadisplaymore2 && (v = v + '<span class="huba-label-meta-more huba-label-meta-more2"><a title="' + m + '" href="' + n + '" title="' + m + '" class="url"  title="' + m + '" target ="_top">Selengkapnya</a></span>'), document.write(v), document.write("</span>"), document.write("</li>")
	}
